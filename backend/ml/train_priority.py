"""
FitResQ ML — Customer Priority Classifier Training Script
Uses TF-IDF Vectorizer + Logistic Regression to classify customer complaints
into LOW, MEDIUM, or HIGH priority levels.
"""
...
def main():
    ...
    data_path = os.path.join(script_dir, "data", "priority_complaints.csv")
    ...
    print("==================================================")
    print("FitResQ ML — Priority Classifier Training")
    print("==================================================")
    print(f"Loading dataset from: {data_path}")

    # 2. Load dataset
    df = pd.read_csv(data_path)
    classes = sorted(df["priority"].unique().tolist())
